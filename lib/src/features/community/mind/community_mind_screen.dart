...
class _CommunityMindScreenState extends State<CommunityMindScreen> with SingleTickerProviderStateMixin {
                            ...
                            Expanded(
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) => InkWell(
                                  ...
                                  child: ListTile(
                                    leading: Icon(
                                      _isIncognito ? Icons.masks_outlined : Icons.person_outline,
                                    ),
                                    title: Text('Experiencia ${index + 1}'),
                                    subtitle: Text(
                                      _isIncognito ? 'Anónimo' : 'Usuario ${index + 1}',
                                    ),
                                    trailing: Chip(
                                      label: Text('${index + 2} respuestas'),
